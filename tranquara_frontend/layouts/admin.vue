  ...
  <div class="min-h-screen bg-gray-50 dark:bg-gray-950 flex">
    ...
    <aside class="hidden lg:flex w-60 flex-col fixed inset-y-0 z-30 border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900">
      <div class="flex items-center gap-2 px-4 h-14 border-b border-gray-200 dark:border-gray-800">
        ...
        <span class="font-semibold text-sm">{{ $t('admin.title') }}</span>
      </div>
...
const navItems = computed(() => [
  { to: '/admin', label: t('admin.nav.dashboard'), icon: 'i-heroicons-chart-bar-square' },
  { to: '/admin/collections', label: t('admin.nav.collections'), icon: 'i-heroicons-rectangle-stack' },
  { to: '/admin/import-export', label: t('admin.nav.importExport'), icon: 'i-heroicons-arrow-down-tray' },
]);
